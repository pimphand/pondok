        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h6 class="page-title">Aktifitas Putri</h6>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Tabel Aktifitas Putri</h4><br>
                            <a href="/female/create" class="btn btn-info btn-sm pull-right" data-bs-toggle="modal" data-bs-target="#CreateAdd"><i class="fas fa-plus-square">Tambah Data</i></a>
                            <hr>
                                ...
                                @foreach ($activity as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{route('female.destroy',['female' => $item->id])}}" method="POST">
                                                @csrf
                                                @method('delete')
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Tambah Aktifitas Putri
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{route('female.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="mb-12">
