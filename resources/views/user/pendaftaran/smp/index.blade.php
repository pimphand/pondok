                        ...
                        <article id="post-1268"
                            ...
                            <div class="clearfix kingster-single-article">
                                <div class="kingster-single-article-content">
                                    ...
                                    <p>
                                        <center>
                                            <img loading="lazy" class="alignnone size-full wp-image-5422"
                                                src="{{asset('storage/browsur/'.$data->image)}}" alt="" width="700"
                                                height="510" />
                                    </p>
                                    <a class="gdlr-core-excerpt-read-more gdlr-core-button gdlr-core-info"
                                        href="{{asset('storage/browsur/'.$data->image)}}.jpg" target="_blank"
                                        download="">
                                        Download Browsure
                                    </a>
                                    </center>
                                    ...
                                    <a class="gdlr-core-excerpt-read-more gdlr-core-button gdlr-core-rectangle"
                                        href="{{route('passsmp')}}" target="_blank">
